...
public class AutoLevelPIDRollCommand extends PIDCommand {

    public static double usfullDrivePower = .30;
    public DrivetrainSubsystem m_DrivetrainSubsystem;

    public AutoLevelPIDRollCommand(DrivetrainSubsystem drivetrainSubsystem){
        super(
            // The controller that the command will use
        new PIDController(0.045, 0, 0),
        // This should return the measurement
        () -> drivetrainSubsystem.GetPitchRoll()[1],
